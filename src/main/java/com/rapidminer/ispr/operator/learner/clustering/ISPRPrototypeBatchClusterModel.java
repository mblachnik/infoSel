 ...
 * @author Marcin
 */
public class ISPRPrototypeBatchClusterModel extends ISPRClusterModel {
    ...
    public ISPRPrototypeBatchClusterModel(AbstractBatchModel model, Map<Integer, String> clusterNamesMap, ExampleSet exampleSet, int k, boolean addCluster, boolean addClusterAsLabel, boolean removeUnknown, boolean addPartitionMatrix) {
