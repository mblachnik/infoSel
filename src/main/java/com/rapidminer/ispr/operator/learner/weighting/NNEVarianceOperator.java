...
import com.rapidminer.ispr.operator.learner.weighting.models.StdNoiseModel;
...
public class NNEVarianceOperator extends AbstractWeightingOperator {
   ...
   //private boolean transformWeights;
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        ParameterType type = new ParameterTypeInt(PARAMETER_K, "The number of nearest neighbors.", 3, Integer.MAX_VALUE, 1);
