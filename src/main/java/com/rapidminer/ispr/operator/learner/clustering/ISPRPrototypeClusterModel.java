 ...
 * @author Marcin
 */
public class ISPRPrototypeClusterModel extends ISPRClusterModel {
     ...
     */
    public ISPRPrototypeClusterModel(ExampleSet trainingSet, ISPRGeometricDataCollection<Number> model, int numberOfClusters, Map<Integer, String> clusterNamesMap, boolean addClusterAsLabel, boolean addCluster) {
