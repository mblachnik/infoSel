...
public class BatchLoopOperator extends OperatorChain {
    ...
    /**
     * PrototypesEnsembeleModel returned by the NearestPrototypesOperator
     */
    private final InputPort prototypesEnsemble  = getInputPorts().createPort("prototype model",PrototypesEnsembeleModel.class);
    /**
