...
public class GroupDistanceOperator extends Operator implements CapabilityProvider {
    ...
    private static final String ATTRIBUTE_NAME_PARAMETER = "Attribute name";
    /**
    ...
    public void doWork() throws OperatorException {
        ...
        ArrayList<Attribute> list = new ArrayList<>(mapSize + 1);
        ...
        GroupSimilarity similarity = new AsymmetricGroupDistance(distance);
        ...
        for (String conditionValue1 : map.getValues()) {
            ...
            for (String conditionValue2 : map.getValues()) {
                ...
                ConditionedExampleSet groupExampleSet2 = new ConditionedExampleSet(exampleSet, condition2);
                double value1 = similarity.calculate(groupExammpleSet1, groupExampleSet2);
                example1.setValue(returnSetAttributes.get(conditionValue2), value1);
                double value2 = similarity.calculate(groupExampleSet2, groupExammpleSet1);
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        //ParameterType type = new ParameterTypeString(ATTRIBUTE_NAME_PARAMETER, "Grouping attribute");
        ParameterType type = new ParameterTypeAttribute(ATTRIBUTE_NAME_PARAMETER, "Grouping attribute", exampleSetInputPort);
        types.add(type);
