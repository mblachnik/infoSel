 ...
 * @author Marcin
 */
public class RENNWithInstanceModifierInstanceSelectionOperator extends AbstractInstanceSelectorOperator {
     ...
     * @param description
     */
    public RENNWithInstanceModifierInstanceSelectionOperator(OperatorDescription description) {
        super(description);
    }
    ...
    public AbstractInstanceSelectorModel configureInstanceSelectionModel(SelectedExampleSet exampleSet) throws OperatorException {
        ...
        return new RENNWithModifierInstanceSelectionModel(measure, k, loss, maxIterations, instanceModifier);                
    }
