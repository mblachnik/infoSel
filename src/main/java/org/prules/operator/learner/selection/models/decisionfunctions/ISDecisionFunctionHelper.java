...
public class ISDecisionFunctionHelper {
    ...
    private static final IISDecisionFunction[] decisionFunctionList = {new ISClassDecisionFunction(), new ISThresholdLinearDecisionFunction(), new ISThresholdRelativeLinearDecisionFunction(), new ISNNEThresholdLinearDecisionFunction(), new ISLocalThresholdLinearDecisionFunction(), new ISLocalThresholdRelativeLinearDecisionFunction()};
    private static final String[] decisionFunctionNames = new String[decisionFunctionList.length];
    private static final String PARAMETER_THRESHOLD = "Threshold";
    private static final String PARAMETER_NOISE_ESTIMATION = "Noise estimation";
    static final String PARAMETER_DECISION_FUNCTION = "Decision function";
