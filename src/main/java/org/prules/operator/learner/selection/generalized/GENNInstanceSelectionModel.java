...
public class GENNInstanceSelectionModel implements PRulesModel<ExampleSet> {
    ...
    GENNInstanceSelectionModel(DistanceMeasure measure, int k, double maxError, boolean relativeError, boolean trainOnSubset, AbstractInstanceSelectorChain evaluator) {
    ...
    public ExampleSet run(ExampleSet inputExampleSet) {
        ...
        for (Example example : exampleSet) {
            ...
            try {
                ...
                resultExample = evaluator.executeInnerModel(trainingSet, testSet);
            } catch (Exception e) {
                exception = e;
                return null;
            }
