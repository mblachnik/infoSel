 ...
 * @author Marcin
 */
public class ENNWithInstanceModifierInstanceSelectionOperator extends AbstractInstanceSelectorOperator {
     ...
     * @param description
     */
    public ENNWithInstanceModifierInstanceSelectionOperator(OperatorDescription description) {
        super(description);
    ...
    public AbstractInstanceSelectorModel configureInstanceSelectionModel(SelectedExampleSet exampleSet) throws OperatorException {
        ...
        return new ENNWithInstanceModifierInstanceSelectionModel(measure, k, loss, classWeight, instanceModifier, weightedNN);        
    }
