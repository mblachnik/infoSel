...
public interface IISDecisionFunction extends Cloneable {
    ...
    /**
     * Function used to define metadata requirements for a loss function. It derives from the fact that some of
     * the decision function require nominal label, some other numerical label, some may need some additional checks.
     * By overriding this method you can define your own meta data requirements.
     * Each first level list represent single error or warning, than in the second level string the first element
     * defines type error/warning than the second parameter
