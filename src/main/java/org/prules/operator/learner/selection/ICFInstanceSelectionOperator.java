...
public class ICFInstanceSelectionOperator extends AbstractInstanceSelectorOperator {
    ...
    public AbstractInstanceSelectorModel configureInstanceSelectionModel(SelectedExampleSet exampleSet) throws OperatorException {
        ...
        return new ICFInstanceSelectionModel(distance, k, maxIterations);
    }
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        ParameterType type;
        type = new ParameterTypeInt(PARAMETER_K, "The number of nearest neighbors.", 1, Integer.MAX_VALUE, 3);
