...
public class VDMNominal2NumericalOperator extends Operator implements CapabilityProvider {
    ...
    private InputPort exampleSetInputPort = getInputPorts().createPort("exampleSet", ExampleSet.class);
    private OutputPort exampleSetOutputPort = getOutputPorts().createPort("exampleSet");
    private OutputPort preProcessingModelOutputPort = getOutputPorts().createPort("preProcessing model");
    private OutputPort originalExampleSetOutputPort = getOutputPorts().createPort("original exampleSet");
