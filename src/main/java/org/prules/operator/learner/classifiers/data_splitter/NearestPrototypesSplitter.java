 ...
 *
 */
public class NearestPrototypesSplitter implements DecisionBorderSplitter {
    ...
    public NearestPrototypesSplitter(ExampleSet prototypeSet, DistanceMeasure distance, double minFactor, int minSupport) {
