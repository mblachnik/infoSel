...
public class SCSVQModel extends SRVQModel {
    ...
    SCSVQModel(ExampleSet prototypes, int iterations, DistanceMeasure measure, double alpha, double temperature, double temperatureRate) throws OperatorException {
