 ...
 */
public class TeNeuralGasVQModel extends AbstractVQModel {
    ...
    public TeNeuralGasVQModel(ExampleSet prototypes, int iterations, DistanceMeasure measure, double alpha, double lambda) throws OperatorException {
        super(prototypes);
